...
function addmessage() {
	window
			.open(
					"province/Publish_Inform_Add.jsp",
					"发布通知",
...
function select(i) {
	...
	form.action = "province/Publish_Inform_Select.jsp";
	window
			.open(
					"province/Publish_Inform_Select.jsp",
					"test",
					"toolbar=yes, location=yes, directories=no, status=no, menubar=yes, scrollbars=yes, resizable=no, copyhistory=yes, width=800, height=600");
	form.submit();
}
...
function update(i) {
	...
	form.action = "province/Publish_Inform_Update.jsp";
	window
			.open(
					"province/Publish_Inform_Update.jsp",
					"test",
					"toolbar=yes, location=yes, directories=no, status=no, menubar=yes, scrollbars=yes, resizable=no, copyhistory=yes, width=800, height=600");
	form.submit();
}
...
function deletem(i) {
	...
	form.action = "province/Publish_Inform_Delete.jsp";
	window
			.open(
					"province/Publish_Inform_Delete.jsp",
					"test",
					"toolbar=yes, location=yes, directories=no, status=no, menubar=yes, scrollbars=yes, resizable=no, copyhistory=yes, width=800, height=600");
	form.submit();
}
