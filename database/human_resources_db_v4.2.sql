...
CREATE TABLE IF NOT EXISTS `user_table` (
  ...
  `user_role` varchar(10) NOT NULL,
  `administor` varchar(20) NOT NULL,
  PRIMARY KEY (`user_id`),
  KEY `fk_role` (`user_role`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


insert into user_table values ("0","0","enterprise","1","1","1");
insert into user_table values ("1","1","province","1","1","0");
insert into user_table values('2','2','city','济南','1','0');
